...
describe('favorite blog', () => {
      ...
      test('favorite blog with multiple blogs', () => {
...
describe('total likes', () => {
  ...
  describe('mostLikes test', () => {
      ...
      test('mostLikes test',() => {
        ...
        expect(result).toEqual(expectedWithOne)
      })

      test('mostLikes test empty array',() => {
  ...
  describe('most blogs by author test', () => {
      ...
      test('multiple blogs and expected to be Robert', () => {
